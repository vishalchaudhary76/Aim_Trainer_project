...
class Target:
    ...
    def draw (self , win):
        ...
        pygame.draw.circle (win, self.secsOND_COLOR, (self.x , self.y), self.size*0.8)
        pygame.draw.circle (win, self.COLOR, (self.x , self.y), self.size*0.6)
        pygame.draw.circle (win, self.secsOND_COLOR, (self.x , self.y), self.size*0.4)
...
def format_time(secs):
    ...
    return f"{minutes:02d}:{second:02d}.{milli}"
